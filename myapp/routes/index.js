...
function upBitgo(){
  request({
    ...
    request({
      method:'GET',
      url:"https://api.kraken.com/0/public/Ticker?pair=ADAUSD,ANKRUSD,ATOMUSD,BATUSD,BCHUSD,DOTUSD,ENJUSD,EOSUSD,FLOWUSD,ICXUSD,KAVAUSD,KNCUSD,LINKUSD,LSKUSD,MANAUSD,OMGUSD,QTUMUSD,REPV2USD,SANDUSD,SCUSD,SRMUSD,STORJUSD,TRXUSD,WAVESUSD,ETCUSD,ETHUSD,LTCUSD,XTZUSD,BTCUSD,XLMUSD,XRPUSD,ZRXUSD",
      dataType: "json",
      cache: false,
